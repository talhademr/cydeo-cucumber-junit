...
public class Order_StepDefinitions {
    ...
    public void userEntersQuantity(int quantity) {
        ...
        //burda sitede hali hazırda bulunan değeri siliyoruz
        orderPage.inputQuantity.sendKeys(Keys.BACK_SPACE);

        orderPage.inputQuantity.sendKeys(quantity+""); // en sondaki stringi sendkeys method sadece string kabul ettiği için yapıyoruz
